...
def draft_context(query: str, chat_history: str) -> str:
    """
    ...
    if prompt := st.chat_input("What's your question?"):
        ...
        with st.chat_message("assistant"):
            ...
            try:
                ...
                context = draft_context(prompt, st.session_state.messages)
                promt = draft_prompt(context)
                messages = [
                    (
                        "system",
